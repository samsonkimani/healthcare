    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="#">kenyatta hospital</a></li>
      <li>  <a href='#'>Nairobi hospital</a></li>
       <li> <a href="#">Aga khan hospital</a></li>
      <li>  <a href="#">Planis view hospital</a></li>
     <li>   <a href='#'>Lions hospital</a></li>
     <li>   <a href='#'>Mp shar hospital</a></li>
     <li>   <a href='#'>medi view hospital</a></li>
     <li>   <a href='#'>pwaani hospital</a></li>
        </ul>
        </li>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        ...
        <i class="fa fa-phone" style="width:30px"></i> Phone: 07765478654<br>
...
<footer class="text-center">
  ...
  <p>Copyright<a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="e-Healthcare">@esther</a></p> 
</footer>
<script>
